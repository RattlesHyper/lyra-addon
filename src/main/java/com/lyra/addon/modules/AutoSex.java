...
public class AutoSex extends Module{
    ...
    private final Setting<List<String>> messages = sgMessage.add(new StringListSetting.Builder()
        ...
        .defaultValue(List.of(
            ...
            "I want you to undress me %player%~",
